...
export function renderSettings(state) {
  return `
    <div class="card-header settings-header">
      <div>
        <p class="eyebrow">Configuración familiar</p>
        <h2>Miembros y tipos de comida</h2>
        <p class="muted">Personaliza quién come en casa y qué comidas quieres planificar. Cada persona podrá tener varios platos en cada comida.</p>
      </div>
    </div>
